...
con = sqlite3.Connection('hotel_proj.db')
cur = con.cursor()
...
#cur.execute("insert into paymentsf values(1,'Pahal','Shrivastava','7049622883','pahalshrivastava12@gmail.com',2,'1','11','2018','11:20:27 PM','Cash','3500')")
...
spath = "images/pahal.jpeg"
simg = ImageTk.PhotoImage(Image.open(spath))
my = Label(sroot,image=simg)
my.image = simg
my.place(x=0,y=0)
#Frame(sroot,height=516,width=5,bg='black').place(x=700,y=0)

Label(sroot,text="Hotel Management System ",font='Helvetica 45 bold italic ',bg='white',fg='black').place(x=400,y=10)
Label(sroot,text="Made by -",font='Helvetica 45 bold italic ',bg='white',fg='black').place(x=550,y=90)
Label(sroot,text="Pahal Shrivastava",font='Helvetica 45 bold italic ',bg='white',fg='blue').place(x=470,y=180)
Label(sroot,text="pahalshrivastava12@gmail.com",font='Helvetica 45 bold italic',bg='white',fg='blue').place(x=360,y=270)
#Label(sroot,text="7049622883",font='Helvetica 30 bold italic',bg='white',fg='grey').place(x=535,y=450)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	root.title("Made with love by Pahal")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Pahal',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Pahal Shrivastava",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
	...
	def reserve():
		...
		Label(b_frame,text='Personal Information',font='msserif 15',bg='white',fg='black').place(x=248,y=10)
		...
		Label(b_frame,text='Contact Information',font='msserif 15',bg='white',fg='black').place(x=248,y=90)
		...
		Label(b_frame,text='Reservation Information',font='msserif 15',bg='white',fg='black').place(x=235,y=180)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
		...
		Label(b_frame,text='Bed(s) :',bg='white',fg='black',font='17').place(x=730,y=50)
		...
		Label(b_frame,text='AC :',font='17',bg='white',fg='black').place(x=732,y=75)
		...
		Label(b_frame,text='TV :',font='17',bg='white',fg='black').place(x=732,y=100)
		...
		Label(b_frame,text='Wifi :',font='17',bg='white',fg='black').place(x=732,y=125)
		#Radiobutton(b_frame,text='Yes',bg='gray93',variable=tvb,value=1,font='15',width=3).place(x=800,y=130)
		#Radiobutton(b_frame,text='No',bg='gray93',variable=tvb,value=0,font='15',width=3).place(x=880,y=130)
		...
		Res = Button(b_frame,text='Reserve',bg='white',fg='cyan4',font='timenewroman 11',activebackground='green',command=booking).place(x=245,y=273)
		unres = Button(b_frame,text='Unreserve',bg='white',fg='cyan4',font='timenewroman 11',activebackground='green',command=unreserve).place(x=327,y=273)
	...
	Label(sl_frame,text='Hotel Status',font='msserif 13',bg='white',fg='black').place(x=53,y=108)
	Label(sl_frame,text='Rooms',font='msserif 13',bg='white',fg='black').place(x=248,y=108)
	Label(sl_frame,text='Reserve',font='msserif 13',bg='white',fg='black').place(x=417,y=108)
	Label(sl_frame,text='Contacts',font='msserif 13',bg='white',fg='black').place(x=774,y=108)
	Label(sl_frame,text='Payments Info',font='msserif 13',bg='white',fg='black').place(x=570,y=108)
	Label(sl_frame,text='Exit',font='msserif 13',bg='white',fg='black').place(x=968,y=108)
